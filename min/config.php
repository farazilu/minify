 ...
 */
/**
 * Allow use of the Minify URI Builder app.
 * Only set this to true while you need it.
 */
 ...
 * set $min_cachePath to an instance.
 * Example below:
 */
...
/**
 * Cache file locking.
 * Set to false if filesystem is NFS. On at least one
 ...
 * is invalid.
 * Minify will attempt to detect when this happens and place a
 ...
 */
 $min_serveOptions['minApp']['allowDirs'] = array('//assets', '//img/assets');
/**
...
/**
 * By default, Minify will not minify files with names containing .
 * min or -min
 ...
 * algorithm can fail.
 * To prevent this, provide an array of link paths to
 ...
 * This may cause Minify to keep serving stale
...
/**
 * Path to Minify's lib folder.
 * If you happen to move it, change
 * this accordingly.
 */
